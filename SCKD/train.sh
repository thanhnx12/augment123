python main.py --task tacred --shot 5 --SAM --SAM_type current --step1_epochs 15 --step2_epochs 10 --step3_epochs 10 
python main.py --task tacred --shot 5 --mixup --SAM --SAM_type current --step1_epochs 15 --step2_epochs 10 --step3_epochs 10 
python main.py --task FewRel --shot 5 --SAM --SAM_type current --step1_epochs 15 --step2_epochs 10 --step3_epochs 10 
python main.py --task FewRel --shot 5 --mixup --SAM --SAM_type current --step1_epochs 15 --step2_epochs 10 --step3_epochs 10
